        ...
        <div class="sidebar-container">
          ...
          <div class="sidebar-menu">
            <ul>
              ...
              <li>
                <router-link :to="{ name: 'charts' }" @click="showMain" :class="{ 'active': $route.name === 'charts' }">
                  <span class="bx bx-bar-chart-alt"></span>
                  <span>Charts</span>
                </router-link>
              </li>
              <li>
                <router-link :to="{ name: 'clock' }" @click="showMain" :class="{ 'active': $route.name === 'clock' }">
                  <span class="bx bxs-user-badge"></span>
                  <span>Je Badge</span>
                </router-link>
              </li>
              <li>
                <router-link :to="{ name: 'profile' }" @click="showMain" :class="{ 'active': $route.name === 'profile' }">
